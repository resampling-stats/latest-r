...
__quarto_custom_context="Block" __quarto_custom_id="618">
...
So far (Section ) we have used the colon syntax to make regular
sequences of integers. For example, to make a vector of the sequential
integers from 3 through 12, we could use:
