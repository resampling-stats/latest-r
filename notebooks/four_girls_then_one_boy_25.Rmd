...
example Section , but now we record “yes” for a smaller number of
composite events.

We record “no” even if a single one boy is chosen but he is chosen 1st,
2nd, 3rd, or 4th, whereas in Section , such outcomes are recorded as
“yes”-es.
...
__quarto_custom_context="Block" __quarto_custom_id="589">
